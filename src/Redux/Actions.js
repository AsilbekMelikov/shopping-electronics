...
export const smartphoneFetchingError = createAction("SMARTPHONE_FETCHING_ERROR")
...
export const filterAllFeaturesDeleted = createAction("FILTER_ALL_FEATURES_DELETED")
